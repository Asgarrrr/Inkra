...
- Website landing page redesign (`apps/website`, Vite/TanStack Start): single-column layout with a header, hero video, and a horizontally scrolling demo gallery (`DemoGallery` component) with scroll-fade blur edges on both sides. No framework migration — the site stays on Vite/TanStack Start.
