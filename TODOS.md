...
- Fuzzy content search and grep: [`SPECs/fuzzy-search-grep-spec.md`](SPECs/fuzzy-search-grep-spec.md), plan [`SPECs/fuzzy-search-grep-plan.md`](SPECs/fuzzy-search-grep-plan.md) — slices 0–3 landed (deps, Rust scan and ranking, streamed command, palette). Remaining: slice 4 (pending-target carrier + navigation fixes), slice 5 (jump to the matched line), slice 6 (brief highlight on arrival).
